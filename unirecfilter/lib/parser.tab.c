...
{
  "$end", "error", "$undefined", "SIGNED", "UNSIGNED", "FLOAT", "COLUMN",
  "EQ", "CMP", "REGEX", "PROTO_NAME", "IP", "STRING", "AND", "OR", "LEFT",
  "RIGHT", "PROTOCOL", "END", "NOT", "$accept", "body", "explist", "exp", YY_NULLPTR
};
#endif
...
{
      -6,    19,    -6,    22,    -6,     1,    18,    -8,     3,    -1,
      -7,     9,     8,    12,    -8,    -8,    -6,    -6,    -8,    -8,
      -8,    -8,    -8,    -8,    -8,    -8,    -8,    -8,    -8,    -8,
      -8,    -8,    -8,    -8,    -8
};
...
{
       2,     0,     0,     0,     0,     0,     3,     4,     0,     0,
       0,     0,     0,     0,    21,     1,     0,     0,    18,    19,
      20,    14,    16,     7,     8,     9,    15,    17,    22,    11,
      12,    13,    10,     5,     6
};
...
{
       1,    15,    23,    24,    25,    27,    18,    19,    20,     2,
      26,     3,    29,     4,    21,    22,    32,    11,    30,    14,
      31,     0,    16,    17,     0,    28,     8,     9,    10,    12,
      13,    16,    17,    33,    34
};

static const yytype_int8 yycheck[] =
{
       6,     0,     3,     4,     5,    12,     3,     4,     5,    15,
      11,    17,     4,    19,    11,    12,     4,     2,    10,     4,
      12,    -1,    13,    14,    -1,    16,     7,     8,     9,     7,
       8,    13,    14,    16,    17
};
...
{
       0,     6,    15,    17,    19,    21,    22,    23,     7,     8,
       9,    22,     7,     8,    22,     0,    13,    14,     3,     4,
       5,    11,    12,     3,     4,     5,    11,    12,    16,     4,
      10,    12,     4,    23,    23
};
...
#line 53 "parser.y" /* yacc.c:1646  */
    { changeProtocol(&(yyvsp[0].ast)); main_tree = (yyvsp[0].ast); }
#line 1260 "parser.tab.c" /* yacc.c:1646  */
    break;

  case 4:
#line 57 "parser.y" /* yacc.c:1646  */
    { (yyval.ast) = newAST((yyvsp[0].ast), NULL, OP_NOP); }
#line 1266 "parser.tab.c" /* yacc.c:1646  */
    break;

  case 5:
#line 58 "parser.y" /* yacc.c:1646  */
    { (yyval.ast) = newAST((yyvsp[-2].ast), (yyvsp[0].ast), OP_AND); }
#line 1272 "parser.tab.c" /* yacc.c:1646  */
    break;

  case 6:
#line 59 "parser.y" /* yacc.c:1646  */
    { (yyval.ast) = newAST((yyvsp[-2].ast), (yyvsp[0].ast), OP_OR); }
#line 1278 "parser.tab.c" /* yacc.c:1646  */
    break;

  case 7:
#line 63 "parser.y" /* yacc.c:1646  */
    { (yyval.ast) = newExpression((yyvsp[-2].string), (yyvsp[-1].string), (yyvsp[0].number), 1); }
#line 1284 "parser.tab.c" /* yacc.c:1646  */
    break;

  case 8:
#line 64 "parser.y" /* yacc.c:1646  */
    { (yyval.ast) = newExpression((yyvsp[-2].string), (yyvsp[-1].string), (yyvsp[0].number), 0); }
#line 1290 "parser.tab.c" /* yacc.c:1646  */
    break;

  case 9:
#line 65 "parser.y" /* yacc.c:1646  */
    { (yyval.ast) = newExpressionFP((yyvsp[-2].string), (yyvsp[-1].string), (yyvsp[0].floating)); }
#line 1296 "parser.tab.c" /* yacc.c:1646  */
    break;

  case 10:
#line 66 "parser.y" /* yacc.c:1646  */
    { (yyval.ast) = newExpression("PROTOCOL", (yyvsp[-1].string), (yyvsp[0].number), 0); }
...
#line 68 "parser.y" /* yacc.c:1646  */
    { (yyval.ast) = (struct ast *) newProtocol((yyvsp[-1].string), (yyvsp[0].string)); }
...
#line 70 "parser.y" /* yacc.c:1646  */
    { (yyval.ast) = (struct ast *) newIP((yyvsp[-2].string), (yyvsp[-1].string), (yyvsp[0].string)); }
...
#line 72 "parser.y" /* yacc.c:1646  */
    { (yyval.ast) = (struct ast *) newString((yyvsp[-2].string), (yyvsp[-1].string), (yyvsp[0].string)); }
...
#line 77 "parser.y" /* yacc.c:1646  */
    {(yyval.ast) = (struct ast *) newNegation((yyvsp[0].ast));}
#line 1368 "parser.tab.c" /* yacc.c:1646  */
    break;

  case 22:
#line 78 "parser.y" /* yacc.c:1646  */
    { (yyval.ast) = (struct ast *) newBrack((yyvsp[-1].ast)); }
